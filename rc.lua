...
globalkeys = gears.table.join(
    ...
    awful.key({ Modkey }, "s", function () awful.client.focus.global_bydirection("left")    end,
              {description = "focus globally in left direction", group = "client"}),
    awful.key({ Modkey }, "n", function () awful.client.focus.global_bydirection("down")    end,
              {description = "focus globally in down direction", group = "client"}),
    awful.key({ Modkey }, "m", function () awful.client.focus.global_bydirection("up")    end,
              {description = "focus globally in up direction", group = "client"}),
    awful.key({ Modkey }, "t", function () awful.client.focus.global_bydirection("right")    end,
              {description = "focus globally in right direction", group = "client"}),

    -- * Swap in direction (globally - swaps even across screens).
    awful.key({ Modkey, "Shift" }, "s", function () awful.client.swap.global_bydirection("left")    end,
              {description = "swap globally in left direction", group = "client"}),
    awful.key({ Modkey, "Shift" }, "n", function () awful.client.swap.global_bydirection("down")    end,
              {description = "swap globally in down direction", group = "client"}),
    awful.key({ Modkey, "Shift" }, "m", function () awful.client.swap.global_bydirection("up")    end,
              {description = "swap globally in up direction", group = "client"}),
    awful.key({ Modkey, "Shift" }, "t", function () awful.client.swap.global_bydirection("right")    end,
